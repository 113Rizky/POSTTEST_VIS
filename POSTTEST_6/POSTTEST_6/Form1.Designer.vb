...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        pnlLogin.Size = New Size(499, 338)
        pnlLogin.TabIndex = 1
        ' 
        ' lblUsername
        ' 
        ...
        lblSubtitle.Location = New Point(124, 91)
        ...
        pnlHeader.Size = New Size(499, 162)
        pnlHeader.TabIndex = 0
        ' 
        ' lblFilmIcon
        ' 
        lblFilmIcon.AutoSize = True
        lblFilmIcon.Font = New Font("Segoe UI", 30F)
        lblFilmIcon.ForeColor = Color.FromArgb(CByte(229), CByte(9), CByte(20))
        lblFilmIcon.Location = New Point(20, 38)
